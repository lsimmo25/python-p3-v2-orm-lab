...
class Review:
    ...
    def __init__(self, year: int, summary: str, employee_id: int, id=None):
        self.id = id
        self.year = year
        self.summary = summary
        self.employee_id = employee_id
        if not Employee.find_by_id(employee_id):
            raise ValueError("Employee with id {} does not exist.".format(employee_id))
    ...
    def employee_id(self, value):
        if not Employee.find_by_id(value):
            raise ValueError("Employee with id {} does not exist.".format(value))
    ...
    @classmethod
    def create(cls, year: int, summary: str, employee_id: int):
    ...
    def get_reviews_by_employee_id(cls, employee_id):
        """Return a list of reviews associated with the employee ID."""
        sql = """
            SELECT *
            FROM reviews
            WHERE employee_id = ?
